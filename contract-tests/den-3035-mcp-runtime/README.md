# DEN-3035 Embedded Alerts MCP runtime provenance

This contract independently fetches the exact public production merge commit for `embedded-alerts/eal-mcp-server.rs`, validates its immutable dependency and protocol boundaries, and compiles and executes it on Linux, macOS, and Windows with both the Rust 1.88.0 MSRV and Rust 1.97.1.
...
Those gates remain separate under DEN-2287, DEN-957, and the shared AI Agent Bridge queue.
